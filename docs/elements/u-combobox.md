...
**Quick intro:**
- Use `<u-comboboxitems>` as a child of `<u-combobox>` - this will contain selected items
- Use `<data>` as direct children of `<u-comboboxitems>` - these are the removable items
...
&lt;u-combobox data-multiple&gt;
  ...
  &lt;input id="my-input" /&gt;
  &lt;del&gt;&times;&lt;/del&gt;
  &lt;u-datalist data-sr-singular="%d flavor" data-sr-plural="%d flavours" hidden&gt;
...
### `<u-comboboxitems>`
- **Attributes:** [all global HTML attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes) such as `id`, `class`, `data-`
- **DOM interface:** `UHTMLComboboxItemsElement` extends [`HTMLElement`](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement)
...
&gt;
  &lt;u-comboboxitems&gt;
    &lt;data&gt;Kokkos&lt;/data&gt;
  &lt;/u-comboboxitems&gt;
  &lt;input id="my-norwegian-input" /&gt;
  &lt;del aria-label="Fjern tekst"&gt;&times;&lt;/del&gt;
  &lt;u-datalist data-sr-singular="%d smak" data-sr-plural="%d smaker" hidden&gt;
...
&lt;u-combobox id="my-matching-combobox"&gt;
  &lt;u-comboboxitems&gt;&lt;/u-comboboxitems&gt;
  &lt;input id="my-matching-input" /&gt;
  &lt;del&gt;&times;&lt;/del&gt;
  &lt;u-datalist hidden&gt;
    &lt;u-option&gt;Coconut&lt;/u-option&gt;
    &lt;u-option&gt;Strawberries&lt;/u-option&gt;
...
&lt;u-combobox id="my-filtering-combobox"&gt;
  &lt;u-comboboxitems&gt;&lt;/u-comboboxitems&gt;
  &lt;input id="my-matching-input" /&gt;
  &lt;u-datalist data-nofilter hidden&gt;
    &lt;u-option&gt;Coconut&lt;/u-option&gt;
    &lt;u-option&gt;Strawberries&lt;/u-option&gt;
    &lt;u-option&gt;Chocolate&lt;/u-option&gt;
    &lt;u-option&gt;Vanilla&lt;/u-option&gt;
...
if (typeof window !== 'undefined') {
  ...
  window.useState = (values) => [window.values, (values) => {
    const { items, itemsElement } = document.getElementById('my-controlled-combobox');
    const isRemoveFirst = [...items].includes(document.activeElement) && window.values[0]?.value !== values[0]?.value

    if (isRemoveFirst) items[0].remove()
    window.values.length = 0; // Empty
    window.values.push(...values);
    window.values.forEach(({ value, label }, index) => {
      Object.assign(items[index] || itemsElement.appendChild(document.createElement('data')), { value, textContent: label })
    });
    [...items].slice(window.values.length).forEach((el) => el.remove()); // Remove unused items
  }]
}
</script>
